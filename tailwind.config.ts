  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'premium-hover': '0 20px 40px -15px rgba(0, 0, 0, 0.1), 0 8px 15px -8px rgba(0, 0, 0, 0.04)',
        'subtle': '0 2px 8px -1px rgba(0, 0, 0, 0.03)',
      },
      backgroundImage: {
        'gradient-emerald': 'linear-gradient(135deg, hsl(var(--primary)) 0%, #10b981 100%)',
