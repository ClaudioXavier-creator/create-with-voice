...
const AgroRcLayout = ({ children }: { children: React.ReactNode }) => {
    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-background overflow-hidden">
        ...
        <div className="flex-1 flex flex-col h-screen overflow-hidden relative">
          {/* Header Minimalista para Agro RC */}
          <header className="h-16 border-b border-border/50 bg-card/50 backdrop-blur-md flex items-center justify-between px-6 shrink-0 z-10">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden sm:flex flex-col items-end">
                ...
                <span className="text-[10px] text-muted-foreground uppercase tracking-widest">Painel RC</span>
              </div>
              <Button
                variant="ghost"
                size="icon"
          ...
          <main className="flex-1 overflow-y-auto overflow-x-hidden relative focus:outline-none custom-scrollbar bg-muted/5">
...
export default memo(AgroRcLayout);
