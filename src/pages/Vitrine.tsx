...
const produtos: ProdutoCard[] = [
  ...
  },
  {
    ...
    icon: Users,
    logo: logoNutriCrm,
    desc: "CRM especializado para nutricionistas técnicos do agro. Gestão de recomendações, visitas técnicas e acompanhamento de resultados em campo.",
    destaques: ["Recomendações Técnicas", "Visitas a Fazendas", "Gestão de Clientes", "Pipeline de Nutrição", "Histórico Técnico", "Relatórios de Visita"],
