...
const produtos: ProdutoCard[] = [
  ...
  },
  {
    ...
    appLink: "https://friendly-flame-igniter.lovable.app/dashboard",
  ...
  },
  {
    ...
    appLink: "https://soil-to-client.lovable.app/dashboard",
  ...
  },
  {
    ...
    appLink: "https://nutricrm.onrender.com/dashboard",
  ...
  },
  {
    ...
    external: true,
    appLink: "https://regional-fixer-charm.lovable.app/dashboard",
